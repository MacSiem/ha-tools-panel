...
const HA_TOOLS_BUILD = '3.2.0';
const HA_TOOLS_BUILD_TS = '20260324-0107';
...
class HAToolsPanel extends HTMLElement {
  ...
  static get TOOLS() {
    return [
      ...
      { id: 'yaml-checker', name: 'YAML Checker', icon: '\uD83D\uDDC2\uFE0F', tag: 'ha-yaml-checker', desc: 'Zaawansowana walidacja plik\u00F3w YAML HA', repo: 'MacSiem/ha-yaml-checker', category: 'debug' },
    ];
  }
